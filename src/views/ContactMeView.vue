        ...
        <div class="info">
            ...
            <div class="contact-info-wrapper">
                ...
                <span class="phone contact-info">
                    ...
                    {{$store.state.info.phone}}
                </span>
            </div>
            <div class="links">
                <a id="linkedin" class="link" :href="$store.state.info.links.linkedin" target="#">
                ...
                <a id="github" class="link" :href="$store.state.info.links.github" target="#">
...
.form{
    ...
    input, textarea{
        ...
        padding: 1rem 1rem;
        border-radius: 5px;
        background-color: rgba(var(--light-purple), 0.25);
        border: none;
...
.button{
    ...
    font-size: 16px;
    color: inherit;
    background-color: rgba(var(--light-purple), 0.75);
    border-radius: 5px;
    width: fit-content;
    box-sizing: border-box;
    border: none;
